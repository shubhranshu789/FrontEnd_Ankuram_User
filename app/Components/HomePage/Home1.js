        ...
        <div className="flex items-center justify-between ">
          ...
          <div className="flex items-center">
            <Link href="/" className="flex items-center">
              <img src="/AnkuramLogo.png" alt="Logo" className="w-12 h-12" style={{width : "90%" , height : "12vh" }}/>
            </Link>
            {/* <nav className="hidden md:flex ml-10 space-x-8">
              <Link to={"/gallery"} className="text-white hover:text-gray-300 font-medium transition-colors">
                Gallery
              </Link>
              <Link  to={"/viewallalbumns"} className="text-white hover:text-gray-300 font-medium transition-colors">
                View All Gallery
              </Link>
            </nav> */}
          </div>
